...
contract SmartStaking {
    ...
    uint256 constant PACKAGE1_PERIOD = 7 days; // should be 7 days in mainnet
    uint256 constant PACKAGE2_PERIOD = 30 days; // should be 30 days in mainnet
    uint256 constant PACKAGE3_PERIOD = 90 days; // should be 90 days in mainnet
    uint256 constant PACKAGE4_PERIOD = 180 days; // should be 180 days in mainnet

    uint256 constant LOCK_PERIOD = 7 days; // should be 7 days in mainnet
    uint256 constant STAKING_MIN_AMOUNT = 500000 ether; // should be 50 pNTY ~ 500,000 NTY/ether in mainnet
    uint256 constant REWARD_TIME_UNIT = 1 days; // should be 1 days in mainnet
